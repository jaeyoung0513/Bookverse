        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/api/", "api/user/login", "/api/user/join",
                                ...
                                .requestMatchers("/api/user/update/{id}", "/api/book/add/wish", "/api/book/delete/wish",
                                        "/api/book/add/cart", "/api/book/delete/cart", "/api/book/buy").hasRole("USER")
                                .requestMatchers("/api/book/add", "/api/book/edit/{id}").hasRole("ADMIN")
