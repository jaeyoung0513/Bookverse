    ...
    <div className={styles.container}>
      ...
      <form> 
          ...
          <label htmlFor="username">아이디</label> 
            <div className={styles.usernameContainer}>              
              <input type="text" id="username" name="username" value={username}
                ...
                required />
              <button type="button" className={styles.checkbtn} onClick={handleCheckUsername}>중복확인</button>
            </div>
        </div> 
        <div className={styles.formGroup}> 
        ...
        <div className={styles.formGroup}> 
          ...
          <button type="submit" className={styles.registerbtn} onClick={handleRegister}>회원가입</button> 
      </form> 
    </div>
  );
}
